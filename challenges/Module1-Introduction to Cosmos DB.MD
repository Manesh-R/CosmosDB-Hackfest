...
1.  In the Azure portal locate the JumpVM and connect to the IP address via RDP. Login/Password information was included in the lab email. Next, open Internet Explorer inside the Windows VM and download the data which we will migrate to Cosmos DB by clicking [here](http://jsonstudio.com/wp-content/uploads/2014/02/stocks.zip)<br/> (http://bit.ly/2CYzX8I)
