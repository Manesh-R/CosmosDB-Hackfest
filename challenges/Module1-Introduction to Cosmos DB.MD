...
2.  **Launch** your **data migration tool** by opening the **dtui** application (From Desktop).<br/>
...
5.  Go to  **C** drive and select the **stocks** folder, click on **stocks.json** to open it.<br/>
<img src="images/importfiles1.jpg"/><br/>   
