...
1. Open the **Terminal**, then start the mongodb Service by running **sudo service mongod start** and  verify the mongoDB database is running by executing the mongo command as shown below.<br/>
